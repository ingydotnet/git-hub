...
_git_hub() {
    local _opts=" -h --help --remote= --branch= --sha= --merge-method= --commit-title= --commit-message= --org= -c= --count= -a --all -q --quiet -v --verbose -r --raw -j --json -A --use-auth -C --no-cache --token= -d --dryrun -T -O -H -J -R -x"
